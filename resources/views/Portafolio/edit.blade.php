        ...
        <div class="row mb-3">
            <div class="col-sm-8 mx-auto mt-2">
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <form action={{ route('update.portafolio', $edit->id ) }} method="POST" class="row g-3 needs-validation">
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="titulo" placeholder="TITULO" autocomplete="off" value="{{ $edit->titulo }}" required>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="categoria" placeholder="CATEGORIA" autocomplete="off" value="{{ $edit->categoria }}" required>
                            </div>
                            <br /><br />
                            <div class="col-sm-6">
                                <input type="file" class="form-control" name="imagen" placeholder="IMAGEN" autocomplete="off" value="{{ $edit->imagen }}" >
                            </div>
                            <div class="col-sm-6">
                                <div class="col-auto">
                                    @csrf
